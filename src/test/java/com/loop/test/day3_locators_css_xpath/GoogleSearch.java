...
public class GoogleSearch {
    ...
    public static void main(String[] args) {
        ...
        if(actualTitle.contains(expectedTitle)){
            ...
            System.out.println("Actual title: " + actualTitle + ", DOES NOT match expected title: " +
        ...
        if(actualURL.contains(expectedURL)){
            ...
            System.out.println("Actual title: " + actualURL + ", DOES NOT match expected title: " +
                    expectedURL + ", => TEST FAIL");
        }
